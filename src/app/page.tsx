  ...
  return (
    <>
      ...
      <main className="pt-24 overflow-hidden">
        {/* Hero Section */}
        <section className="relative min-h-[90vh] flex items-center px-margin-mobile md:px-margin-desktop py-16 overflow-hidden">
          {/* Background elements */}
          ...
          <div className="max-w-container-max mx-auto w-full z-10 text-center flex flex-col items-center">
            <div className="space-y-10 max-w-4xl w-full">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary-fixed rounded-full text-primary font-label-sm mx-auto shadow-sm text-center">
                <span className="material-symbols-outlined text-[16px]">
                  verified
                </span>
                Empowering Enterprise with Intelligence
              </div>
              <h1 className="text-headline-lg-mobile sm:text-display-lg md:text-[64px] font-display-lg text-primary leading-[1.1]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-4 justify-center items-stretch sm:items-center w-full max-w-md sm:max-w-none mx-auto px-4">
                <a
                  href="#solutions"
                  className="bg-secondary text-on-secondary px-8 py-4 rounded-lg font-headline-md text-body-md hover:bg-on-secondary-fixed-variant transition-all flex items-center justify-center gap-2 group shadow-lg w-full sm:w-auto"
                >
                  Explore Solutions
                ...
                <button className="border-2 border-primary text-primary px-8 py-4 rounded-lg font-headline-md text-body-md hover:bg-primary hover:text-on-primary transition-all w-full sm:w-auto">
                  Get Started
                </button>
              </div>
            </div>
        ...
        {/* About Section */}
        <section
          className="py-16 md:py-24 px-margin-mobile md:px-margin-desktop bg-surface-container-low relative"
          id="about"
        >
        ...
        <section className="py-16 md:py-24 px-margin-mobile md:px-margin-desktop" id="solutions">
          <div className="max-w-container-max mx-auto space-y-12">
            <div className="text-center space-y-4 max-w-2xl mx-auto">
              <h2 className="text-headline-lg-mobile md:text-headline-lg font-headline-lg text-primary">
                Core Solutions
              </h2>
              <p className="text-on-surface-variant text-body-sm sm:text-body-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[280px]">
              <div className="md:col-span-8 glass-card rounded-2xl overflow-hidden group relative">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-background via-background/40 to-transparent p-6 sm:p-8 flex flex-col justify-end">
                  <span
                    className="material-symbols-outlined text-secondary mb-2 sm:mb-4 text-4xl"
                    style={{ fontVariationSettings: "'FILL' 1" }}
                  >
                    school
                  </span>
                  ...
                  <p className="text-on-surface-variant text-body-sm sm:text-body-md max-w-md">
              ...
              <div className="md:col-span-4 bg-primary text-on-primary rounded-2xl p-6 sm:p-8 flex flex-col justify-between">
                ...
                <p className="text-surface-variant text-body-sm sm:text-body-md">
                  High-frequency analytics, sentiment intelligence from news
                  cycles, and predictive market modeling for agile decisioning.
                </p>
              </div>
              <div className="md:col-span-4 glass-card rounded-2xl p-6 sm:p-8 flex flex-col justify-between border-b-4 border-secondary">
                <div className="space-y-4">
                  <span
        ...
        {/* Why Choose Us */}
        <section
          className="py-16 md:py-24 px-margin-mobile md:px-margin-desktop bg-primary relative overflow-hidden"
          id="why"
        >
          ...
          <div className="max-w-container-max mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-gutter items-center">
              <div className="space-y-8">
                <h2 className="text-headline-lg-mobile md:text-headline-lg font-headline-lg text-on-primary">
                  Why Choose Us
                </h2>
              ...
              <div className="relative mt-12 lg:mt-0">
                <div className="aspect-square max-w-[400px] mx-auto bg-secondary/10 rounded-3xl border border-white/10 p-8 sm:p-12 flex items-center justify-center">
                  <img
        ...
        <section className="py-12 md:py-16 px-margin-mobile md:px-margin-desktop bg-surface">
          <div className="max-w-container-max mx-auto">
        ...
        <section className="py-16 md:py-24 px-margin-mobile md:px-margin-desktop text-center relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto relative z-10 space-y-12">
            <div className="space-y-6">
              ...
              <h2 className="text-headline-lg-mobile md:text-display-lg font-display-lg text-primary leading-tight">
                &ldquo;To build intelligent AI systems that fundamentally improve how
                people learn, work, and communicate.&rdquo;
              </h2>
            </div>
            <div className="glass-card p-6 sm:p-12 rounded-3xl border-2 border-secondary/20 shadow-2xl space-y-8">
              <h3 className="text-headline-lg-mobile md:text-headline-lg font-headline-lg text-primary">
